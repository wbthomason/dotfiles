...
function! PackagerInit() abort
  ...
  call packager#add('ncm2/ncm2', {'type': 'opt'})
  call packager#add('roxma/nvim-yarp', {'type': 'opt'})
  call packager#add('ncm2/ncm2-path', {'type': 'opt'})
  call packager#add('ncm2/ncm2-syntax', {'type': 'opt'})
