...
local colors = {
  ...
  error_selected = { guifg = error_fg, guibg = selected_bg, gui = 'bold,italic' },
  warning = { guifg = warning_fg, guibg = elem_bg, guisp = warning_fg },
  warning_selected = { guifg = warning_fg, guibg = selected_bg, gui = 'bold,italic' },
  info = { guifg = info_fg, guibg = elem_bg, guisp = info_fg },
  info_selected = { guifg = info_fg, guibg = selected_bg, gui = 'bold,italic' },
