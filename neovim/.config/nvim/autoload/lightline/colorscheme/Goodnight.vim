" =============================================================================
" Filename: autoload/lightline/colorscheme/Goodnight.vim
" Author: wbthomason, adapted from itchyny
" License: MIT License
" Last Change: 2017/12/06 12:55:00.
" =============================================================================
let s:base3 = '#c5c8c6'
let s:base2 = '#bababa'
let s:base1 = '#a0a0a0'
...
let g:lightline#colorscheme#Goodnight#palette = lightline#colorscheme#fill(s:p)
