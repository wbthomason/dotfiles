...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets yapfify yaml-mode white-theme which-key wgrep wc-mode utop use-package twilight-bright-theme tuareg toml-mode slime-company scribble-mode scala-mode restart-emacs rainbow-mode rainbow-delimiters racket-mode racer py-isort popup-kill-ring parinfer paradox ox-pandoc ox-clip org-projectile org-plus-contrib org-noter org-journal org-evil org-bullets org-autolist olivetti ocp-indent no-littering modern-cpp-font-lock mixed-pitch meson-mode merlin markdown-toc magit-popup lsp-ui lsp-treemacs lispyville lisp-extra-font-lock linum-relative kaolin-themes ivy-xref ivy-rich ivy-prescient intero ialign hl-todo hindent highlight-parentheses highlight-indent-guides google-c-style golden-ratio gitignore-templates gitignore-mode gitconfig-mode git-gutter geiser format-all focus flyspell-correct flycheck-rust flycheck-pycheckers flycheck-pos-tip flycheck-irony flycheck-haskell flycheck-ghcmod flycheck-clangcheck flx fish-mode eziam-theme eyebrowse evil-visualstar evil-textobj-anyblock evil-terminal-cursor-changer evil-snipe evil-matchit evil-magit evil-lion evil-leader evil-goggles evil-fringe-mark evil-expat evil-escape evil-embrace evil-commentary evil-collection evil-args esh-autosuggest eldoc-eval eink-theme ein dtrt-indent doom-modeline deft deadgrep counsel-tramp counsel-projectile counsel-etags company-reftex company-prescient company-posframe company-math company-lua company-lsp company-ghci company-ghc company-cabal company-c-headers company-auctex cmake-font-lock ccls cargo browse-kill-ring biblio base16-theme auto-dictionary auto-compile auctex-latexmk amx all-the-icons-ivy all-the-icons-dired)))
